...
public class CenterController {
    ...
    @GetMapping
    public List<BloodBankCenter> all(
        ...
        return city == null
            ? centers.findAll()
            : centers.findByCityIgnoreCase(city);
    }

    @PostMapping
    public BloodBankCenter create(
        @RequestBody BloodBankCenter center
    ) {
